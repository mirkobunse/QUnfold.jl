...
@testset "Execution of all methods" begin
    ...
    for (name, method) in [
            ...
            "HDy (softmax)" => HDy(c, 3; strategy=:softmax_reg, fit_classifier=false),
